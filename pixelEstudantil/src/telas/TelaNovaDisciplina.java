	...
	public TelaNovaDisciplina() {
		...
		btnConfirmar.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				if(!tfNomeDisciplina.getText().equals("") && !tfCodigo.getText().equals("")) {
					PessoaDAO pessoaDAO = new PessoaDAO();
					Disciplina novaDisciplina = new Disciplina(tfNomeDisciplina.getText(), Integer.parseInt(tfCodigo.getText()));
					pessoaDAO.gravarDiciplina(novaDisciplina);
					JOptionPane.showMessageDialog(null, "Disciplina "+novaDisciplina.getNome()+" criada com sucesso.");
				}
			}
		});
