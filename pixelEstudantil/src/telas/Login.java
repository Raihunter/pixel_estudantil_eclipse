...
public class Login extends JFrame {
	...
	public Login() {
		...
		jlBemVindo.setIcon(new ImageIcon(Login.class.getResource("/imagens/painelmine(1).png")));
		
		JLabel jlImagenLogin = new JLabel("");
		jlImagenLogin.setBounds(0, 0, 550, 600);
		panelImageLogin.add(jlImagenLogin);
		jlImagenLogin.setIcon(new ImageIcon(Login.class.getResource("/imagens/telalogin.jpg")));
