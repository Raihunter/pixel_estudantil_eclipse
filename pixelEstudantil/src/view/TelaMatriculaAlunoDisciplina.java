...
import tablelModel.DisciplinaTableModel;

@SuppressWarnings("serial")
public class TelaMatriculaAlunoDisciplina extends javax.swing.JFrame {
...
//	}
    ...
    public TelaMatriculaAlunoDisciplina() {
        initComponents();
//        popularTabela();
        PessoaDAO pessoaDAO = new PessoaDAO();
    ...
    public static void main(String[] args) {
		EventQueue.invokeLater(new Runnable() {
			public void run() {
				try {
					TelaMatriculaAlunoDisciplina frame = new TelaMatriculaAlunoDisciplina();
