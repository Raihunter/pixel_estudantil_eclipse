		...
		btnCadastrar.addActionListener(new ActionListener() {
			...
			public void actionPerformed(ActionEvent e) {
				...
				if(!tfSenhaCadastro.getText().equals(tfConfirmarSenhaCadastro.getText())) {
					...
					boolean sucesso;
					ProfessorController pfController = new ProfessorController();
					sucesso = pfController.cadastrarProfessor(tfNomeCadastro.getText(), tfEmailCadastro.getText(), tfSenhaCadastro.getText());
					if(sucesso == true) {
